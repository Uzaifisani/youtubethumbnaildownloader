...
function fetchImage()
{
    ...
    <button  type="button" class="btn btn-info" onclick="location.href='https://img.youtube.com/vi/${vCode}/maxresdefault.jpg'">Full HD Image</button>
    <button type="button" class="btn btn-info" onclick="location.href='https://img.youtube.com/vi/${vCode}/hqdefault.jpg'">HD Image</button>
    <button type="button" class="btn btn-info" onclick="location.href='https://img.youtube.com/vi/${vCode}/mqdefault.jpg'">360p Image</button>
    </br></br>
